...
#define MOTOR_PORT_CONNECTION       PORTA_ID  // Motor port connection
#define PIN_INT1                    PIN0_ID   // Motor pin INT1
#define PIN_INT2                    PIN1_ID   // Motor pin INT2
#define PIN_INT3                    PIN2_ID   // Motor pin INT3
#define PIN_INT4                    PIN3_ID   // Motor pin INT4
