...
#include "../../MCAL/ICU/icu.h"  /* Include ICU driver for echo pulse measurement */
...
#define TRIGGER_PORT_CONNECTION    PORTC_ID  /* Port connected to the trigger pin */
#define TRIGGER_PIN1               PIN3_ID   /* Pin connected to the trigger pin */

/* Define the port and pin for the ultrasonic sensor's echo pin */
#define ECHO_PORT_CONNECTION       PORTD_ID  /* Port connected to the echo pin */
#define ECHO_PIN                   PIN6_ID   /* Pin connected to the echo pin */
